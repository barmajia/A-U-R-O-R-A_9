...
GRANT ALL ON FUNCTION "public"."can_start_conversation"("from_user_id" "uuid", "to_user_id" "uuid", "product_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."find_nearby_factories"("seller_id" "uuid", "max_distance_km" numeric, "limit_count" integer) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_factory_rating"("p_factory_id" "uuid") TO "anon";
